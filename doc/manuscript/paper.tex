...
\item {\em P. falciparum} is the deadliest parasite causing human malaria,
responsible for more than 500,000 death in 2015. Our lack of understanding of
the parasite gene regulation of its complex life cycle is an impediment to the
development of novel therapies. Recent evidence points towards unusual means
of gene regulation, possible through changes in its genome architecture. A
better understanding of how DNA folds into the nucleus and how it influences
gene expression could provide new leads for developing new drugs.
\item In the meantime, the development of new means to probe samples for the
three-dimensional structure of DNA paves the way for in depth and systematic analysis of genome
...
\item Here, I review recent methodological developments \fixme{finish this} 
\end{itemize}
...
While safe and effictive vaccines still remains a hope and drug resistance to anti
...
\begin{figure}
\includegraphics[width=\linewidth]{schemas/3D_structures.pdf}
...
HiC data set of {\em P. falciparum}. Each color corresponds to a chromosome.
...
\subsection*{Volume-exclusion modeling cannot explain {\em P. falciparum}'s
genome architecture}
...
co-localized at one end of the nucleus, telomeres are in physical contacts,
...
domain-like enrichment in interactions did not appear in the simulated VE map
(See Figure~\ref{fig:ve_modeling})

\begin{figure}
\caption{Volume Exclusion Modeling}{}
\label{fig_ve_modeling}
\end{figure}
...
study the contact maps?  \fixme{why?}In this section, I will review a number of downstream
analysis one can do on 3D models, highlighting but not limiting myself to results
on the 3D structure of {\em P. falciparum}. \fixme{why}
